              ...
              <div>
                  ...
                  >
                    <tr class>
                      ...
                      >
                        ...
                        >
                          <b>
                            <br />2nd floor Tres Montañas Building <br />Room
                    ...
                    <tr>
                      ...
                      <td
                        style="
                          ...
                          border-style: solid solid solid none;
                        "
                        @dblclick="changeDueDate"
                      >
                        <span v-if="modiView.due_date">
                          <div class="input-group">
                            <date-picker
                              v-model="modiView.data.due_date"
                              :config="AppliedDateoptions"
                              autocomplete="off"
                              @input="changeDueDateOK"
                            ></date-picker>
                          </div>
                        </span>
                        <span v-else>{{ data.due_date }}</span>
                      </td>
                ...
                <div class="rowFields mx-auto row">
                  ...
                  >
                    ...
                    <tr v-if="data.client.package_type_id == '2'">
                      <td
                        style="
                          border: 1px solid black;
                          padding: 10px;
                ...
                <p
                  ...
                  "
                >
                  * NON-PAYMENT OF ACCOUNTS SHALL BE SUBJECT FOR TEMORARY
                  DISCONNECTION
                  ...
                  <span style="color: red"
                    >“THIS DOCUMENT IS NOT VALID FOR CLAIMING INPUT TAXES”</span
                  >
                </p>
                <p
                  class="bottomfet"
                ...
                >
                  <i>
                    Thank you for having business with us. We are happy to serve
                    you more.
                  </i>
                </p>
              </div>
      ...
      <template slot="modal-footer" slot-scope="{}">
        <div v-if="data.saved">
          ...
          <b-button
            ...
            >Email</b-button
          >
          <b-button size="sm" variant="danger" @click="btnDelState"
            >Delete</b-button
          >
        </div>
        <div v-else>
          <b-button size="sm" variant="success" @click="saveStatement"
            >Saved</b-button
          >
        </div>
      </template>
