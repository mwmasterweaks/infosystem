        ...
        <div class="rowFields mx-auto row">
          ...
          <div class="col-lg-9">
            <model-list-select
              ...
              v-validate="'required'"
            ></model-list-select>
            <small class="text-danger pull-left" v-show="errors.has('area_id')">Area is required.</small>
          </div>
        </div>
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "area.region.name", label: "Region", sortable: true },
