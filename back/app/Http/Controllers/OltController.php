...
class OltController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return $this->show($request->node_id);
        } catch (\Exception $ex) {
            \Logger::instance()->log(
                Carbon::now(),
                $request->user_id,
    ...
    {
        $tbl = olt::with(['splitter_lcp'])->where('node_id', $id)
            ->get();
        return response()->json($tbl);
    }
